...
// 👇 COLOQUE SEU LINK DO WHATSAPP AQUI
const WHATSAPP_LINK = "https://wa.me/5519974123215?text=Ol%C3%A1%2C%20Quero%20saber%20mais%20sobre%20a%20hub"; 
    ...
    <main className="min-h-screen bg-white font-sans">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-lg border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <a 
            href={videoFinished ? WHATSAPP_LINK : "#"} 
            target="_blank"
          ...
          >
            Entrar no WhatsApp <ArrowRight size={14} />
          </a>
        </div>
      </nav>
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <FadeIn delay={0.3}>
              ...
              >
                {videoFinished ? "QUERO ENTRAR AGORA" : "ASSISTA O VÍDEO PARA LIBERAR"}
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          <FadeIn>
            ...
            <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto">
              Clique abaixo e entre agora mesmo para a maior comunidade brasileira sobre HubTask.
            </p>
            <a 
              href={videoFinished ? WHATSAPP_LINK : "#"} 
              target="_blank"
            ...
            >
              ...
              {videoFinished ? "ENTRAR NO WHATSAPP" : "AGUARDE O VÍDEO TERMINAR"}
              <ArrowRight size={20} className="group-hover:translate-x-1 transition-transform" />
            </a>
          </FadeIn>
        </div>
      ...
      <div className={`fixed bottom-0 left-0 right-0 z-50 md:hidden p-4 bg-white/90 backdrop-blur-lg border-t border-gray-100 transition-transform duration-300 ${
        ...
        >
          {videoFinished ? "ENTRAR NO WHATSAPP" : "ASSISTIR PARA LIBERAR"}
          <ArrowRight size={18} />
        </a>
      </div>
    </main>
